...
<nav role="navigation" class="navbar navbar-inverse">
	        ...
	        <div id="navbarCollapse" class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	                ...
	                <li><a onclick="mostraranucios();" >Mis Anuncios</a></li>
...
<form action="{{ URL::action('RegistronaturalesController@organizaciones')}}" method="POST" id="f1">
<!-- {{ Form::open(['action' => 'UsuariosController@store']) }} -->
	...
	<div class="form-group">
	    ...
	    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese nombre o marca de la empresa">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="razon_social" name="razon_social" placeholder="Ingrese razon social">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="rubro" name="rubro" placeholder="Ingrese telefono">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="contacto" name="contacto" placeholder="Ingrese nombre del contacto">
		@foreach($errors->get('contacto') as $error)
			<p class="alert-danger">{{ $error }}</p>
			@endforeach
	</div>

	<button type="submit" class="btn btn-primary btn-right">Guardar</button>
